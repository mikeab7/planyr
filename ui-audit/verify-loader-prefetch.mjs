// B219 + B220 — verify on the built app (dist/):
//  • idle prefetch injects a <link rel=prefetch> for the Schedule iframe doc (B219)
//  • navigating to Schedule shows the themed "assembling" loader in #7F77DD (B220)
