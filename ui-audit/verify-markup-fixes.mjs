 ...
 *   NEW-2 / B566: a callout/text box has more generous horizontal padding by default.
 *   NEW-3 / B567: a native color picker applies LIVE (onInput) — the selected object recolors the
...
await assertMeasurable(page, "verify-markup-fixes");
...
console.log("\n== NEW-3 (B567): a color picker recolors the selection live, one-step undo ==");
...
console.log("\n== NEW-2 (B566): callout/text box horizontal padding is more generous by default ==");
