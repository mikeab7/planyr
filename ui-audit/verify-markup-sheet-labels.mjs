/* Verify B266 + B341 — the single-sheet "Markup" sidebar now shows REAL sheet labels (sheet # +
 ...
 *   B341 — 4 pages collapse to 2 logical entries; a "Grading Plan · C-5–C-7 · 3 sheets" group that
...
console.log("\nB341 — the Markup sidebar collapses the set into logical sheets:");
...
console.log("\nB341 — the group expands to its member sheets + auto-calibrate dot:");
