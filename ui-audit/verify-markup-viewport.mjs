/* Verify B329 — the Markup canvas now uses the shared viewport TRANSFORM engine (parity with
...
function buildPdf() {
  const s1 = "BT /F1 20 Tf 60 700 Td (SHEET ONE - B329 transform viewport test) Tj ET";
...
await assertMeasurable(page, "verify-markup-viewport");
const pageErrors = [];
