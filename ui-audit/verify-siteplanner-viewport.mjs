/* B313 regression guard — the Site Planner map/planner must behave EXACTLY as before after its
...
try {
  ...
  // path; the Pan rail button needs the rail open). The pan-drag code is untouched by B313 —
