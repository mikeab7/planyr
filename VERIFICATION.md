...
## 🔲 Needs verification
### V70 — Optimistic concurrency: a stale save is rejected with a "reload" prompt (B274) ⏳ — needs the migration + a signed-in two-session check
...
### V69 — Multi-tab warning: same project open in another tab raises a banner (B275) ✅ (self-verified headless — fully done)
