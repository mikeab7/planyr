...
## 🔲 Needs verification
### V101 — Restore the compact, app-wide cloud-sync badge in AppHeader Row 1 (B366) ✅ (self-verified headless — every state rendered + the live header wiring; one optional signed-in eyeball on the real cloud round-trip)
