...
## 🔲 Needs verification
### V152 — B493: Schedule loader handshake works against the REAL embedded app (signed-in / live) ✅ lint 0 · 1641 tests · build green · headless `verify-scheduler-loader.mjs` 3/3 (embed stubbed); ⏳ one live check with the real embed
