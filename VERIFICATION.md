...
## 🔲 Needs verification
### V170 — B556: deleting a building no longer re-shows the phantom "changed in another session" prompt ✅ headless tombstone 6/6 + unit here; ⏳ signed-in conflict-banner confirm owed
