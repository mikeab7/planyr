...
- **One known follow-up (coverage, not a failure).** The B280 fixture seeds a *site*, not a *doc_review with a PDF*, so **Section B's per-tool ARM assertions skip** on live (the rail only renders with a PDF open). They're fully wired and will execute the moment a doc_review+PDF fixture is seeded — tracked as B436 (Open). Cadence: once per engine change. Last checked: 2026-06-24, live green.
