...
## 🔲 Needs verification
### V90 — Doc Review: the single-sheet Markup sidebar shows real sheet labels + logical groups (B266 + B343) ✅ (self-verified headless — browser-only, no signed-in check needed)
