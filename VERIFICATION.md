...
## 🔲 Needs verification
### V73 — Auto-filing: drop a drawing → it reads the title block → files itself (B297) ✅ (self-verified headless — dormant-path no-regression proven; ⏳ deploy-gated live read + signed-in round-trip)
