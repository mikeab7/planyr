...
## 🔲 Needs verification
### V70 — Coverage-aware Layers picker: relevance modes + Mapillary rename/gating + jurisdiction-vector retry (B282–B286) ✅ (self-verified headless — fully done; ⏳ one optional signed-in note)
