...
## 🔲 Needs verification
### V80 — Undo (Ctrl+Z) reliably reverts a building move in one step (B313) ✅ (self-verified headless — fully done, browser-only, no signed-in check needed)
