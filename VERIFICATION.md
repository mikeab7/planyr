...
## 🔲 Needs verification
### V101 — A deleted site STAYS deleted — no reappear mid-session or after reload (B366) ✅ (self-verified headless, logged-out — the actual bug; ⏳ one optional signed-in cloud-error-banner eyeball)
- **Added** 2026-06-22 · **Cadence** once (bug-fix acceptance) · **Last checked** 2026-06-22 ✅ (headless **Chromium**, built app, `vite preview`, logged-out — `ui-audit/verify-b366-delete-durable.mjs`, **6/6**) · **Next check** — one optional **signed-in** eyeball below; the sandbox CORS-blocks Supabase auth.
