...
## 🔲 Needs verification
### V91 — Doc Review: scanned (image-only) drawings are read by OCR into the auto-assembly pipeline (B349) ✅ (self-verified headless, incl. the LIVE Tesseract engine — fully done, browser-only)
