...
## 🔲 Needs verification
### V137 — B473: new-site data-loss mitigation (save-verify + "Save now") + logged-out path proven ✅ headless 10/10 (`ui-audit/verify-new-site-save.mjs`) + lint 0 + 1528 tests + build green + `verify-readonly-takeover.mjs` 7/7 (no regression); ⏳ ONE live signed-in occurrence to pin the root cause
