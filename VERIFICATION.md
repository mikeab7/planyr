...
### V140 — B474 Stage B (increment): underlay raster → IndexedDB (off the 5 MB cap + survives reload) ✅ lint 0 · 1573 tests (+2) · build green · headless 7/7 (`ui-audit/verify-b474-underlay-idb.mjs`) — nothing pending
