...
## 🔲 Needs verification
### V68 — Coverage-aware Layers picker: relevance modes + Mapillary rename/gating + jurisdiction-vector retry (B274–B278) ✅ (self-verified headless — fully done; ⏳ one optional signed-in note)
