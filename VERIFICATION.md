...
## 🔲 Needs verification
### V66 — Auto-filing: drop a drawing → it reads the title block → files itself (B270) ✅ (self-verified headless — dormant-path no-regression proven; ⏳ deploy-gated live read + signed-in round-trip)
