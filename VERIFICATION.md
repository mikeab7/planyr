...
- **Result ✅ (all checks passed):**
  ...
  - **B226 selected-or-hovered:** nothing-selected & not-hovering = **0** buttons; hovering the building = **8** (revealed by hover alone — `b222-hover.png` shows the add-buttons with NO selection grips); moving off = **0**. So the buttons appear on the ONE active building only, gated by the same size rule.
