 ...
 * three can never drift apart again (B227). Pure constants — no React — so JSX
 ...
 *     status dot, chip, or pin. (Before B227 the pins wrongly borrowed the module
 *     greens/ambers for status, which is the mismatch this set closes.)
 *
 * Reassignment rationale (B227): Complete moved green→gray so GREEN reads as
