...
export default function LayerPanel({ overlays, setOverlays, county, layerStatus = {}, compact = false }) {
  ...
  const row = (k, cfg) => {
    ...
    const vintage = layerVintage(k, cfg); // NEW-5 (B229): source vintage, distinct from refreshed-age
    return (
      <div key={k} style={{ marginBottom: 5 }}>
        ...
        {/* NEW-5 (B229): source VINTAGE — the data's own currency, low-weight + honest
