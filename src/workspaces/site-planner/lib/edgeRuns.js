/* Edge "runs" — group a parcel's boundary edges into logical SIDES (B207).
 *
 ...
 * and stacks one dimension label per segment (B208). A "run" is a maximal chain
 ...
 * `mid` is its arc-length midpoint (for placing one label/pill per side, B208).
 */
