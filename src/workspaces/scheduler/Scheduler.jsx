...
export default function Scheduler({
    ...
    const onMsg = (e) => {
      ...
      if (m && m.source === "planar-seq" && m.type === "planar:toolbar-state") {
        setToolbar({
          ...
          offlineFallback: !!m.offlineFallback, // B562 — cloud-unreachable → badge shows honest "offline", not a false "synced"
  ...
  // B562 — the Schedule workspace now shows the SAME unified top-right cloud sync badge as the
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "#f6f8fa" }}>
      <AppHeader
        ...
        homeLabel="Dashboard"
        // B562 — unified cloud save-status badge (Row-1, top-right), replacing the floppy Save
