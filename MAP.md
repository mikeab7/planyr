...
- **`src/workspaces/library/components/FolderTree.jsx`** — Library per-project folder-tree editor (B650): add / inline-rename / move / delete via a right-click context menu (B677) + the enumerated delete-safety modal + Drive-mirror status.
