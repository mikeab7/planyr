...
- **`src/workspaces/notes/lib/notesPageWidth.js`** — TODO — describe
  - _exports_: `dragWidthFromDelta`, `FULL_WIDTH_FLOOR`, `FULL_WIDTH_GUTTER`, `PAGE_WIDTH_MAX`, `PAGE_WIDTH_MIN`, `PAGE_WIDTH_PRESETS`, `pageWidthLabel`, `pageWidthPresetId`, `resolvePinnedBaseWidth`, `resolvePresetPx`
