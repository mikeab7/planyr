...
> **Generated 2026-08-07 @ `fa1175f` by `scripts/build-map.mjs` — do not hand-edit the inventory.**
...
- **`src/workspaces/notes/lib/notesBlockKeys.js`** — TODO — describe
...
- **`src/workspaces/notes/lib/notesPastePlain.js`** — TODO — describe
