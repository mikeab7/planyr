...
- **`src/workspaces/scheduler/components/LinkSchedulePanel.jsx`** — Schedule tab's empty state (rendered instead of the iframe) offering create-or-link for an unlinked Site Planner project; never auto-links, nothing to dismiss
