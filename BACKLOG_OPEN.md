...
> _228 open · 530 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B934400 | Delete `.github/workflows/pr-auto-ready.yml`: `GITHUB_TOKEN` can never perform either of its two mutations here, so a job that only ever fails or goes quiet stays in the repo for no benefit | [Infra / CI] | #infra | live |
...
- **#mobile** — B917073, B758546, B849635, B748960, B734529
- **#model** — B891184
