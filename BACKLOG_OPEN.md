...
> _328 open · 802 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B1801041 | `verify-notes-pan.mjs` declares itself VACUOUS: its fixture has 0px of horizontal slack, so two pan arms cannot be measured at all | [Notes / testing] | #notes #testing | sandbox |
...
| B1777120 | Every schedule in the account is one record, so any save contends with every other tab | [Scheduler / storage] | #scheduler #persistence #sync | live |
...
| B1795456 | Scale badge: match the map chrome, one dot, two-tone label | [Site Planner / map overlay] | #site-planner #ui | ⏳ live — awaiting |
