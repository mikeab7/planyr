...
> _66 open · 53 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B758 | Fort Bend floodplain-mitigation rule: replace the 1:1 placeholder in `floodplainRules.js` with the verified FBC record | [Site Planner] | #site-planner #yield #floodplain | sandbox |
| B759 | Fort Bend FFE/buildability record: multi-basis `max()` FFE rule (currently `null`) | [Site Planner] | #site-planner #yield #floodplain | sandbox |
| B760 | Harris floodplain + buildability seeds: verify & correct against the 7/9/2019 regs | [Site Planner] | #site-planner #yield #floodplain | sandbox |
| B761 | Harris detention: HCED Infrastructure-Regs outfall-type minimums layer (0.75 / 1.0) | [Site Planner] | #site-planner #yield | sandbox |
| B762 | `wse1pct` provider: consume NFHL cross-sections (S_XS) alongside the shipped BFE-lines tier | [Site Planner / GIS] | #site-planner #gis #yield #floodplain | live |
| B763 | `wse02pct` + Atlas-14 WSE providers: MAAPnext (draft-advisory), M3 pointer, FBCDD Atlas-14 studies layer | [Site Planner / GIS] | #site-planner #gis #yield #floodplain | live |
| B764 | Fort Bend detention record enrichment + HEC-HMS tier-threshold correction | [Site Planner] | #site-planner #yield | sandbox |
...
- **#floodplain** — B758, B759, B760, B762, B763, B755
- **#gis** — B762, B763, B752, B753, B720, B721, B722, B723, B724, B726, B691, B629, B370, B309, B178, B171, B147, B13, B95, B625, B755, B751, B754, B745, B739, B738, B707, B712, B703, B704, B705, B706, B695, B694, B693
...
- **#yield** — B758, B759, B760, B761, B762, B763, B764, B724, B553, B755, B751, B754, B715, B712, B651
