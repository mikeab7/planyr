...
> _203 open · 436 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B590016 | The right-click menu is one long list; split it into Word's mini-toolbar + a short command menu | [Notes] | #notes #ui | sandbox |
| B590017 | The menu runs off the bottom of the screen and hides "Delete this box" behind the taskbar | [Notes] | #notes #ui | sandbox |
| B590018 | With several boxes selected, dragging one moved only that one | [Notes] | #notes #ui | sandbox |
