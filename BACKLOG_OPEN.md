...
> _223 open · 508 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B839841 | A "10pt"/"9pt" font-size string is read as pixels everywhere, never converted | [Notes] | #notes #ui | sandbox |
| B831600 (×3) | Selecting across table cells jumped and flashed | [Notes] | #notes #ui #selection | live |
