...
> _214 open · 483 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B727936 | Every row a plan DUPLICATE creates carries `op_kind: "unknown"` — the duplicate-plan flow never opens an operation | [Site Planner / persistence] | #site-planner #persistence #sync | sandbox |
