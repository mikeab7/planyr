...
> _226 open · 530 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B914448 | CLAUDE.md told sessions `pr-auto-ready.yml` marks PRs ready automatically — it never has | [Docs] | #infra | sandbox |
| B914449 | Stop `pr-auto-ready.yml` failing red on the known, permanent B793696 FORBIDDEN condition; announce loudly if it ever recovers | [Infra / CI] | #infra | sandbox |
...
- **#mobile** — B758546, B849635, B748960, B734529
- **#model** — B891184
