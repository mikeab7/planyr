...
> _322 open · 789 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B1717617 (×2) | A reach-capped road-to-road tee return near a road's own end reads as a truncated arc closed off with a straight bevel/kink | [Site Planner / road] | #site-planner #road #geometry | live |
...
| B1629618 | `planar_data` (the Schedule) has a revision token but no database-side enforcement of it — a cross-tab/cross-device race can still clobber a save | [Scheduler] | #persistence #scheduler | sandbox |
...
| B1717616 (×3) | An oblique road into a POLYGON paving pad's acute-side curb return FOLDS: one segment carries an 87–108° turn mid-run | [Site Planner / road] | #site-planner #road #geometry | ⏳ live — awaiting |
...
| B1683296 | Double-clicking the sketch canvas while a blank box is pending destroys it and creates nothing | [Notes / sketch] | #notes #ui | ⏳ live — awaiting |
