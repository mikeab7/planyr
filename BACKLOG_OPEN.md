...
> _205 open · 439 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B623680 | The Notes carry-forward lives in the REPO, wired so a fresh session reads it unprompted | [Notes / process] | #notes #infra #testing | sandbox |
...
| B576001 | Food pins look geographically lopsided at metro-wide zoom — diagnosed, not fixed | [Food] | #food #gis #testing | ⏳ live — awaiting |
