...
> _194 open · 425 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B512672 | Tab on the FIRST item of a list now INDENTS IT, and never invents an empty parent bullet | [Notes] | #notes #ui | sandbox |
| B512673 | The three harness traps that keep coming back, written down | [Infra / CI · testing] | #testing #infra | sandbox |
...
| B342996 (×3) | A device whose tree is 98 revisions STALE is also flagged dirty, so a merge lets it overwrite newer titles | [Notes] | #notes #sync | live |
