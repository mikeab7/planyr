...
> _59 open · 127 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B874 | Post-ship: drainage "refresh" state machine reportedly gets STUCK | [Site Planner / yield] | #site-planner #yield #floodplain | live |
| B875 | Pond discoverability | [Site Planner] | #site-planner #pond #ui | live |
...
| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B877 | Header: drop the school district (ISD) from the jurisdiction badge + fix the Row-1 breadcrumb/badge overlap at narrow widths | [Site Planner] | #site-planner #ui #gis | ⏳ live — awaiting |
...
| B867 | Stale fetch prices mitigation required at a hard 0.00 (silent-failure class) + dev-speak stale box swallowed the Reviewing-agency input | [Site Planner] | #site-planner #yield #floodplain #gis | ⏳ live — awaiting |
...
| B859 | Waller County rule records: 500-yr mitigation trigger, conditioned FFE rules, no-structural-fill hard stop, floodway + 100-ft buffer | [Site Planner / floodplain] | #site-planner #floodplain #yield | ⏳ live — awaiting |
| B856 | Unstudied Zone A: estimated-WSE provider (grade along the zone boundary) so mitigation, heat map, and pond split stop dead-ending | [Site Planner / floodplain] | #site-planner #floodplain #yield #gis | ⏳ live — awaiting |
| B857 | Suggested pad FFE: compute the jurisdictional minimum and offer it into the blank Pad/FFE field | [Site Planner / floodplain] | #site-planner #floodplain #yield | ⏳ live — awaiting |
| B858 | Pond purpose designation (Detention / Mitigation / Hybrid) + band-driven sizing assistant | [Site Planner / stormwater · yield] | #site-planner #pond #yield #floodplain | ⏳ live — awaiting |
...
| B833 | Transition wedges are real fill: daylight slopes join the proposed surface, the mitigation ledger, and the heat map — and the engine daylights ASAP | [Site Planner / grading · yield] | #site-planner #grading #yield #floodplain | ⏳ live — awaiting |
| B834 | Pond roles + a real mitigation-provided ledger (detention vs mitigation vs dual, credited not footnoted) | [Site Planner / stormwater · yield] | #site-planner #pond #yield #floodplain #ui #export | ⏳ live — awaiting |
...
| B830 | Ledger-balancer: rank the moves that close detention + mitigation together (the adversarial pass as a feature) | [Site Planner / stormwater · yield] | #site-planner #pond #yield #floodplain | ⏳ live — awaiting |
...
| B828 | Undo records + reverts edits that previously slipped the history stack (four "undo doesn't work" gaps) | [Site Planner / Review] | #site-planner #doc-review #ui | ⏳ live — awaiting |
...
| B809 | Fill-depth heat map overlay: render the exact cells the engine priced | [Site Planner / yield · ui] | #site-planner #yield #floodplain #ui #export | ⏳ live — awaiting |
| B826 | Proposed-surface engine: auto-grade the concept from FFE + rules, then earthwork balance and mitigation priced off the real surface | [Site Planner / grading · yield] | #site-planner #grading #yield #floodplain | ⏳ live — awaiting |
...
| B815 | Meeting calendars: recurrence + agenda-deadline rules for external decision bodies | [Scheduler] | #scheduler #entitlements #testing | ⏳ live — awaiting |
...
- **#doc-review** — B484, B471, B423, B422, B413, B411, B406, B364, B267, B268, B269, B273, B180, B181, B183, B20, B38, B828, B791, B792, B750, B746, B687, B685, B667, B659
- **#drive** — B663, B662, B629, B791, B792, B699, B701, B687
- **#entitlements** — B818, B725, B726, B868, B869, B817, B816, B815
- **#export** — B818, B810, B752, B862, B839, B840, B834, B809, B824, B817, B816, B745, B739, B738, B712, B684
...
- **#floodplain** — B874, B873, B866, B867, B868, B869, B870, B871, B861, B862, B859, B856, B857, B858, B833, B834, B830, B808, B809, B826, B827, B807, B798, B802, B790, B789, B788, B782, B755
- **#gantt** — B818, B817, B816
- **#gis** — B810, B776, B777, B752, B753, B722, B723, B724, B726, B629, B370, B309, B178, B171, B147, B13, B95, B877, B867, B860, B861, B856, B839, B840, B832, B831, B808, B822, B827, B691, B807, B796, B797, B800, B801, B790, B789, B788, B787, B782, B775, B774, B761, B625, B755, B751, B754, B745, B739, B738, B707, B712, B703, B704, B705, B706, B695, B694, B693
...
- **#persistence** — B662, B648, B499, B495, B483, B474, B479, B163, B128, B134, B20, B38, B860, B851, B846, B863, B864, B836, B835, B832, B829, B819, B796, B799, B800, B791, B792, B793, B784, B785, B786, B812, B811, B759, B757, B756, B751, B746, B742, B743, B716, B701, B692, B682, B676, B667, B673, B674, B714
- **#pond** — B875, B866, B869, B870, B871, B858, B834, B829, B830, B831, B822, B707
- **#road** — B742, B719
- **#scheduler** — B818, B778, B495, B865, B851, B850, B863, B864, B836, B835, B817, B816, B815, B644
- **#selection** — B741, B872, B820, B750, B746, B742, B743, B740, B737, B682, B651
- **#site-planner** — B874, B875, B842, B810, B776, B777, B752, B753, B741, B723, B724, B725, B629, B499, B484, B474, B479, B423, B406, B370, B309, B182, B183, B178, B177, B171, B163, B147, B115, B13, B95, B877, B873, B872, B866, B867, B868, B869, B870, B871, B860, B861, B862, B859, B856, B857, B858, B846, B839, B840, B837, B832, B833, B834, B829, B830, B831, B828, B808, B809, B826, B821, B824, B823, B822, B827, B691, B820, B807, B796, B797, B798, B799, B800, B801, B802, B793, B790, B789, B788, B787, B784, B785, B786, B782, B812, B811, B775, B774, B761, B759, B757, B756, B625, B755, B751, B754, B747, B748, B749, B750, B745, B746, B739, B744, B742, B743, B740, B738, B737, B719, B717, B715, B716, B707, B712, B703, B704, B705, B706, B695, B694, B693, B692, B684, B682, B651, B673, B674, B714
- **#stitching** — B413, B839
- **#testing** — B269, B63, B873, B863, B836, B815, B743
- **#thoroughfare** — B722, B723, B724, B725, B726
- **#ui** — B875, B842, B810, B741, B735, B723, B115, B877, B872, B865, B862, B851, B850, B846, B837, B834, B828, B809, B821, B824, B823, B820, B819, B798, B799, B801, B802, B790, B761, B758, B750, B746, B744, B742, B740, B719, B734, B717, B712, B706, B695, B693, B669, B668, B658, B673, B674
- **#yield** — B874, B724, B873, B872, B866, B867, B868, B869, B870, B871, B860, B861, B862, B859, B856, B857, B858, B832, B833, B834, B829, B830, B808, B809, B826, B824, B823, B822, B827, B807, B796, B797, B798, B799, B802, B782, B755, B751, B754, B715, B712, B651
