...
|---|---|---|---|---|
| B1215536 | `NoteHistory` has the SAME phone-width defect B1203505 just fixed for `NoteOutline`, unfixed | [Notes] | #notes #ui #mobile | sandbox |
