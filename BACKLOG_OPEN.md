...
> _165 open · 389 awaiting live verification._
...
| B342996 | A device whose tree is 98 revisions STALE is also flagged dirty, so a merge lets it overwrite newer titles | [Notes] | #notes #sync | live |
...
| B377889 | Restore Building 3's truck court and trailer row on Richfield / Concept A (`smsdrvzr9gzx`) | [Site Planner / data] | #site-planner #persistence | ⏳ live — awaiting |
| B377888 | A stale delete re-applies onto elements CREATED after it, and ate the owner's truck court | [Site Planner / Persistence] | #site-planner #persistence #sync | ⏳ live — awaiting |
| B377890 | A "heal" that produces a physically impossible layout must fail, not report success | [Site Planner] | #site-planner #persistence #testing | ⏳ live — awaiting |
...
| B366389 | The Rename/Delete glyphs were a text pencil beside a colour emoji, and the sweep that followed | [Shared UI] | #ui | ⏳ live — awaiting |
