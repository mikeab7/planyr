...
<<<<<<< HEAD
> _196 open · 427 awaiting live verification._
=======
> _193 open · 428 awaiting live verification._
>>>>>>> origin/main
...
|---|---|---|---|---|
| B532640 | "Single" line spacing was 1.65, so the control looked inert and nothing could be made compact | [Notes] | #notes #ui | sandbox |
| B532641 | Line height was pinned to the block's own font, so smaller text did not make a shorter row | [Notes] | #notes #ui | sandbox |
| B532642 | A one-click Compact density for a whole note | [Notes] | #notes #ui | sandbox |
| B519680 | ⛔ REGRESSION IN B512672: Shift+Tab moved an ANCESTOR, so one keypress dragged whole branches the user never touched | [Notes] | #notes #ui | sandbox |
