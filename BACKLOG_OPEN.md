...
> _227 open · 556 awaiting live verification._

## 🔲 Open

| B# | Title | Module | Tags | Verify |
|---|---|---|---|---|
| B1012560 | Schedule header: tab strip clips AND the centre group sits permanently off-centre, both because Row 2 splits leftover space 50/50 between two groups whose needs are unequal | [App shell / header] | #ui | sandbox |
| B1012561 | Enumerate the break width AND the centre-alignment offset for all six module headers, not just Schedule | [App shell / header] | — | sandbox |
