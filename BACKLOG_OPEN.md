...
|---|---|---|---|---|
| B532112 | A probe must answer a KNOWN case correctly before it is trusted on an unknown one | [ui-audit / harness] | #testing | sandbox |
