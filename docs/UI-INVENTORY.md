...
| 0px | 23px | 12px | 400 | `rgba(0, 0, 0, 0)` | `0px none rgb(0, 0, 0)` | Collapse ×1 | src/shared/comps/components/CompEntryGrid.jsx:1125:          <table style={{ borderCollapse: "collapse", tableLayout: "fixed" }}> (+27 more matches, best-effort) |
