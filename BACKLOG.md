...
### B478 — Persistence "state-of-the-art" perf refactors (the deferred tail of the B477 review) `[Site Planner / Persistence]` (enhancement/perf)  *(spun out of the B477 adversarial review, 2026-06-26; these are the findings the verifiers marked fixNow=false — real but larger/riskier than a same-session patch, NOT data-loss. B477 shipped all the data-loss + honesty fixes.)*
