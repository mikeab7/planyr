...
`[ ]` **Phase 1 machinery shipped + unit-tested; source now wired (B650); turning on.** Remaining to go live: trigger the first nightly-builder run (secrets are in place per Cowork 2026-07-04) + the V199 live click-through. Then a lot draws + selects from Planyr's saved copy even with the county server 100% down.
