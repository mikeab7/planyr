...
### B685 — The Site Planner inspector / left panel doesn't theme to dark (hardcoded cream) `[Site Planner / UI]` (bug) #site-planner #ui  *(found 2026-07-06 during the B657-5B convergence screenshot pass; minted **B685** = highest real B# across both files (B684) + 1)*
