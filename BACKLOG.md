...
### B488 — Security pen-test pass (2026-06-27): cross-user PDF read in team storage + OAuth token-page hardening `[Security / RLS + edge]` (security)  *(owner-requested "exhaustive penetration tests"; 5 parallel surface audits — edge Functions, edge proxies, OAuth, Supabase RLS, client XSS/secrets; minted **B488** = highest real B# (B487) + 1)*
