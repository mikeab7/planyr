...
### B639 — Persistence & Sync epic: one umbrella + a canonical write-path doc `[Site Planner / Persistence]` (epic — standing umbrella) #persistence  *(chat "NEW-4" 2026-07-04; minted **B639** = next after B638; branch `claude/backlog-infra-verify-gates-xsdxsi`)*
...
- **Members** (each gains a `Part of: B639` line): B124, B125, B126, B134, B276, B314, B595, B596, B612.
...
- **Triage rule:** every new save/sync bug files as a member of B639 and must name the invariant (**I1–I4** in `docs/PERSISTENCE.md`) it violates. If none fits, the invariant list is incomplete → amend `docs/PERSISTENCE.md` first, then file.
...
- Part of: **B639** (Persistence & Sync epic).
