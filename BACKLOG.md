...
### B472 — DATA LOSS: a NEW site's edits can vanish on reload when signed in (root cause un-pinned; mitigated + instrumented) `[Site Planner / Persistence]` (bug, DATA-LOSS)  *(owner repro 2026-06-25 on planyr.io, signed in; minted **B472** = highest B# (B471) + 1)*
