...
### B596 — Renaming a site snapped right back to the old name after Enter `[Site Planner]` (bug)  *(owner-reported 2026-06-30 on planyr.io — "I renamed a site in the site planner module and pressed enter and it went right back to the old name"; minted **B596** = highest real B# across both files (B595) + 1; branch `claude/site-planner-rename-revert-dk6yoq`)*
