...
- **Defaults provisional** (56 length / 50 depth / 60 speed / 9×12 door, band 50–58) pending the owner's real reference sets (Goose Creek / Grand Port / Pinnacle — NOT yet uploaded to the repo, only scheduler project names); the flex band + the two bay targets are the dials to re-tune once the drawings land. **→ OWNER-TODO.**
