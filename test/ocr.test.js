...
describe("ocrScaleFor — render density (B352)", () => {
...
describe("wordsToItems — Tesseract boxes → page-unit items (B352)", () => {
...
describe("createOcrRunner — orchestrate render→recognize→convert (B352)", () => {
