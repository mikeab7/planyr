...
describe("ocrScaleFor — render density (B343)", () => {
...
describe("wordsToItems — Tesseract boxes → page-unit items (B343)", () => {
...
describe("createOcrRunner — orchestrate render→recognize→convert (B343)", () => {
