...
describe("terrainWorker — worker-safe import discipline", () => {
  ...
  it("imports ONLY the pure terrain modules", () => {
    ...
    expect(imports).toEqual(["./contourTrace.js", "./demGrid.js", "./flowField.js", "./lercGrid.js"]);
  });
...
describe("the pure terrain modules stay worker-safe too", () => {
  for (const f of ["demGrid.js", "contours.js", "contourTrace.js", "flowField.js", "lercGrid.js"]) {
