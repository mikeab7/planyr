# Handoff — Auto-filing (B299): drop a drawing → it files itself
...
`BACKLOG-DONE.md` (B299), and `VERIFICATION.md` (V74).
...
- **Headless self-verified** (`ui-audit/verify-b299-autofiling.mjs`, logged-out): the Project
...
ui-audit/verify-b299-autofiling.mjs    # headless smoke
```
...
### B. Live verification (VERIFICATION V74) — after A
